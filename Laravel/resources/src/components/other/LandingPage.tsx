            ...
            <section className="pt-24 pb-20 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative w-full max-w-md mx-auto overflow-visible group">
                            <ImageWithFallback
                                src="https://images.unsplash.com/photo-1606216794074-735e91aa2c92?w=600&h=800&fit=crop&crop=center"
                                alt="Professional photographer at work"
                                className="w-full h-full object-cover scale-95 relative z-0 rounded-lg"
                            />

                            {/* Gradient overlay */}
                            <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent z-5 transition-opacity duration-500 group-hover:opacity-80 rounded-lg"></div>

                            {/* Text và nút */}
                            <div className="absolute bottom-6 left-6 text-white z-10 transition-all duration-500 group-hover:-translate-y-1 group-hover:scale-105">
                                <div className="flex items-center gap-2 mb-2">
                                    <div className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center transition-all duration-500 group-hover:scale-110">
                            ...
                            <div className="absolute -top-6 -right-6 bg-white dark:bg-slate-800 rounded-lg p-3 shadow-md border border-slate-200 dark:border-slate-700 z-10 transition-all duration-500 group-hover:-translate-y-1 group-hover:shadow-lg">
                                <div className="flex items-center gap-3">
                                    <div className="w-6 h-6 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center transition-all duration-500 group-hover:scale-110">
                            ...
                            <div className="absolute -bottom-6 -right-8 bg-white dark:bg-slate-800 rounded-lg p-3 shadow-md border border-slate-200 dark:border-slate-700 z-10 transition-all duration-500 group-hover:-translate-y-1 group-hover:shadow-lg">
                                <div className="flex items-center gap-3">
                                    <div className="w-6 h-6 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center transition-all duration-500 group-hover:scale-110">
                                        <Heart className="w-3 h-3 text-purple-600 dark:text-purple-400" />
                                    </div>
                                    <div>
                                        <p className="font-medium text-[9px]">
                                            100% hài lòng
                        ...
                        <div className="text-center relative">
                            ...
                            <div className="bg-sky-50 dark:bg-sky-900/20 rounded-2xl p-6 border border-sky-200 dark:border-sky-800">
                                ...
                                <p className="text-slate-600 dark:text-slate-300">
                                    ...
                                    nghiệp. Xem portfolio, đánh giá và chọn
                                    người phù hợp nhất.
                                </p>
                            </div>
                        </div>
                        ...
                        {[
                            {
                                ...
                                answer: "Bạn chỉ cần tải ứng dụng Momentia, duyệt qua danh sách nhiếp ảnh gia, chọn ngư��i phù hợp và đặt lịch trực tiếp. Quá trình rất đơn giản và nhanh chóng.",
                            },
                            {
            ...
            <section className="py-20 sky-gradient text-white relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
                    ...
                    <p className="text-xl text-white/90 mb-8">
                        Tải ứng dụng Momentia ngay hôm nay và đặt lịch chụp ảnh
                        với những nhiếp ảnh gia tốt nhất
                    </p>
