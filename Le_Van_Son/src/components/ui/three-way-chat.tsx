...
export function ThreeWayChat({ bookingId, currentUser, onBack }: ThreeWayChatProps) {
  ...
  const [messages] = useState<ThreeWayMessage[]>([
    {
      ...
      content: 'Chào mọi người! Tôi là điều phối viên phụ trách buổi chụp này. Có gì cần hỗ trợ xin liên hệ.',
      timestamp: '10:00',
      type: 'text'
    },
    {
      ...
      content: 'Em muốn đổi địa điểm chụp từ Hồ Gươm sang Công viên Thống Nhất được không ạ?',
      timestamp: '10:30',
      type: 'text'
    },
    {
    ...
    },
    {
      ...
      content: 'Được em, anh ok với địa điểm mới. Công viên Thống Nhất cũng có nhiều góc đẹp để chụp.',
      timestamp: '10:35',
      type: 'text'
    },
    {
      ...
      senderName: participants.coordinator.name,
      senderAvatar: participants.coordinator.avatar,
      content: 'Tôi đã xác nhận thay đổi địa điểm. Buổi chụp sẽ diễn ra tại Công viên Thống Nhất.',
      timestamp: '10:40',
      type: 'text'
    },
    {
      ...
      <div className="bg-white border-b p-4">
        ...
        <div className="flex items-center gap-2 mt-3 overflow-x-auto">
          {Object.entries(participants).map(([key, participant]) => (
            <div key={key} className="flex items-center gap-2 bg-gray-100 rounded-full px-3 py-1 whitespace-nowrap">
              <ImageWithFallback
                ...
                <Card className="max-w-xs border-2 border-dashed border-blue-200 bg-blue-50">
                  <CardContent className="p-3">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-medium text-blue-900">Thay đổi booking</span>
                      <Badge className={getChangeStatusColor(message.bookingChange!.status)}>
                    ...
                    <div className="space-y-2 text-sm">
                      <div>
                        ...
                        <span className="font-medium">{message.bookingChange!.field}</span>
                      </div>
