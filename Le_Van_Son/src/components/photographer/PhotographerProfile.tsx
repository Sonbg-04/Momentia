      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="p-4 max-w-2xl mx-auto space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <ShieldCheck className="w-5 h-5" /> Tổng quan
                bảo mật
              </CardTitle>
            </CardHeader>
            <CardContent className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="p-3 rounded-lg border bg-white">
                ...
                <p className="text-xs text-gray-500">
                  Gửi thông báo khi tài khoản đăng nhập trên
                  thiết bị lạ.
                </p>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Smartphone className="w-5 h-5" /> Phiên hoạt
                động
              </CardTitle>
            </CardHeader>
        ...
        {MAIN_MENU_ITEMS.map((item) => {
          ...
          return (
            <Button
              ...
              variant="outline"
              className={`h-16 flex-col gap-2 ${item.bgColor || ""} ${item.hoverBg || ""}`}
            >
